...
<head>
  ...
  <title>Presto | @yield('title')</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="" class="logo">
      ...
      <span class="logo-mini"><b>P</b>CP</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><img src="{{asset('AdminLTE/dist/img/prsto.svg')}}"></span>
    </a>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018-2019 <a href="#">Presto Lanka (Pvt)LTD.</a></strong> All rights
    reserved.
  </footer>
