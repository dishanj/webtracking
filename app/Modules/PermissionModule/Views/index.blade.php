@extends('layouts.master') @section('title','Permission Add')
...
@section('content')
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <div class="">
                <div class="col-md-10">
                    <form role="form" action="{{url('permission/add')}}" class="form-horizontal" method="post">
                        {{ csrf_field() }}

                        <div class="row">
                            <div class="form-group col-md-4 m-b-5">
                                <label class="control-label required">Permission</label>
                                <input type="text" class="form-control @if($errors->has('permission')) error @endif"
                                       id="permission" name="permission" placeholder="Permission"
                                       value="{{Input::old('permission')}}">
